    ...
    Card  (
        ...
        Column (
            ...
            OutlinedTextField(
                ...
                onValueChange = { viewModel.onEvent(GastoEvent.DescripcionChange(it)) },
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    it.toDoubleOrNull()?.let { monto ->
                        viewModel.onEvent(GastoEvent.MontoChange(monto))
                    }
                },
            ...
            Row (
                ...
                Button (
                    onClick = {
                        viewModel.onEvent(GastoEvent.Save)
                    },
                    modifier = Modifier
                        .weight(1f)
                        .padding(4.dp)
                ...
                Button(
                    onClick = {
                        viewModel.onEvent(GastoEvent.New)
                    },
                    modifier = Modifier
                        .weight(1f)
                        .padding(4.dp)
